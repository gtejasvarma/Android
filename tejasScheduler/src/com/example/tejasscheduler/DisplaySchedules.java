...
import com.example.tejasscheduler.model.ActiveSchedules;
...
public class DisplaySchedules extends PreferenceActivity {
		...
		btnSet.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				intentEmail.putExtra(Intent.EXTRA_EMAIL,
						new String[] { "sowmyavuddaraju@gmail.com" });
	...
	private void openSettings() {
		...
		UnitSelection.setTitle("Select activity");
	...
	private void fillScreen(final Context context) {
		...
		for (ActiveSchedule activeSchedule : list) {
			...
			String mobileNumber = MapperUtils
			...
			final CharSequence[] str = { eventName + " scheduled to "
					+ contactName + " at " + formattedDate };
